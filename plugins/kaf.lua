local SUDO = 100481835 -- put Your ID here! <===
local MRoO = 100481835 -- put Your ID here! <===
...
local function warning(msg)
	...
	local d = math.floor(expiretime / 86400) + 1
        if tonumber(d) == 1 and not is_sudo(msg) and is_mod(msg) then
			if lang then
				tdcli.sendMessage(msg.to.id, 0, 1, 'از شارژ گروه 1 روز باقی مانده شارژ گروه', 1, 'md')
			else
...
----------------------------------------
local function delmsg (MaTaDoR,Nikootins)
    msgs = MaTaDoR.msgs 
    for k,v in pairs(Nikootins.messages_) do
        msgs = msgs - 1
        tdcli.deleteMessages(v.chat_id_,{[0] = v.id_}, dl_cb, cmd)
        if msgs == 1 then
            tdcli.deleteMessages(Nikootins.messages_[0].chat_id_,{[0] = Nikootins.messages_[0].id_}, dl_cb, cmd)
            return false
        end
    end
    tdcli.getChatHistory(Nikootins.messages_[0].chat_id_, Nikootins.messages_[0].id_,0 , 100, delmsg, {msgs=msgs})
end
----------------------------------------
...
local lang = redis:get(hash)
 ...
 if not lang then
  ...
  return 'گروه از لیست گروه های ربات حذف شد'
end
end
----------------------------------------
...
if not lang then
 return "*>Lιηк* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`"
elseif lang then
 return "قفل لینک هم اکنون فعال است"
end
else
...
if not lang then
 return "*Tag* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل تگ هم اکنون فعال است️"
end
else
...
if not lang then
 return "*username* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل یوزرنیم هم اکنون فعال است️"
end
else
...
if not lang then
 ...
 return "قفل نام یوزرنیم فعال شد"
end
end
end
...
elseif lang then
return "قفل یوزرنیم فعال نمیباشد"
end
else 
...
if lock_mention == "lock" then
if not lang then
 return "*>Mєηтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل فراخوانی افراد هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل فراخوانی افراد فعال نمیباشد"
end
else 
...
if not lang then
 return "*>Aяαвιc/Ƥєяѕιαη* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل عربی و فارسی هم اکنون فعال است️"
end
else
...
if not lang then
 ...
 return "قفل عربی و فارسی فعال شد"
end
end
end
...
elseif lang then
return "قفل عربی و فارسی فعال نمیباشد"
end
else 
...
return "قفل عربی و فارسی غیرفعال شد"
end
end
end
...
if not lang then
 return "*english* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل انگلیسی هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل انگلیسی فعال نمیباشد"
end
else 
...
if not lang then
 return "*>Ɛɗιтιηg* `Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل ویرایش هم اکنون فعال است"
end
else
...
elseif lang then
return "قفل ویرایش فعال نمیباشد"
end
else 
...
if not lang then
 return "*>Sραм* `Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل اسپم هم اکنون فعال است️"
end
else
...
if lock_flood == "lock" then
if not lang then
 return "*>ƑƖσσɗιηg* `Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل پیام مکرر هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل پیام مکرر فعال نمیباشد"
end
else 
...
return "قفل پیام مکرر غیرفعال شد"
end
end
end
...
if not lang then
 return "*>Ɓσтѕ* `Ƥяσтєcтιση Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل ربات هم اکنون فعال است️"
end
else
...
if lock_join == "lock" then
if not lang then
 return "*>Lσcк Jσιη* `Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "ورود به گروه هم اکنون ممنوع است️"
end
else
...
if lock_markdown == "lock" then
if not lang then 
 return "*>Mαякɗσωη* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل فونت هم اکنون فعال است️"
end
else
...
if lock_webpage == "lock" then
if not lang then
 return "*>Ɯєвραgє* `Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل صفحات وب هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل صفحات وب فعال نمیباشد"
end
else 
...
if not lang then
 return "*>AƖƖ ƖσƇк* `Iѕ AƖяєαɗу Lσcкєɗ`️"
elseif lang then
 return "قفل کلی گروه هم اکنون فعال است"
end
else
...
elseif lang then
return "قفل کلی گروه فعال نمیباشد"
end
else 
...
return "قفل کلی گروه غیرفعال شد"
end
end
end
...
if lock_pin == "lock" then
if not lang then
 return "*>Ƥιηηєɗ Mєѕѕαgє* `Iѕ AƖяєαɗу Lσcкєɗ`"
elseif lang then
 return "قفل سنجاق هم اکنون فعال است"
end
else
 data[tostring(target)]["settings"]["lock_pin"] = "lock"
save_data(_config.moderation.data, data) 
...
if not lang then
 return "*>Mυтє Ɠιf* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل گیف فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Ɠαмє* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل بازی هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє IηƖιηє* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل کیبورد شیشه ای هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل کیبورد شیشه ای فعال نمیباشد"
end
else 
...
if not lang then
 return "*>Mυтє Ƭєxт* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل متن هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Ƥнσтσ* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل عکس هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Ʋιɗєσ* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل فیلم هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Aυɗισ* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل آهنگ هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Ʋσιcє* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل ویس هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Sтιcкєя* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل استیکر هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل استیکر فعال نمیباشد"
end
else 
...
if not lang then
 return "*>Mυтє Ƈσηтαcт* `Iѕ AƖяєαɗу ƐηαвƖєɗ`"
elseif lang then
 return "قفل مخاطب هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Ƒσяωαяɗ* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل فروارد هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل فروارد فعال نمیباشد"
end 
else 
...
if not lang then
 return "*>Mυтє Lσcαтιση* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل موقعیت هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل موقعیت فعال نمیباشد"
end
else 
...
if not lang then
 return "*>Mυтє Dᴏᴄᴜᴍᴇɴᴛ* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل فایل هم اکنون فعال است"
end
else
...
if mute_tgservice == "mute" then
if not lang then
 return "*>Mυтє ƬgSєяνιcє* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل سرویس هم اکنون فعال است️"
end
else
...
if not lang then
 return "*>Mυтє Ƙєувσαяɗ* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "قفل صفحه کلید هم اکنون فعال است️"
end
else
...
elseif lang then
return "قفل صفحه کلید فعال نمیباشد"
end 
else 
...
local function list_plugins(only_enabled, msg)
  ...
  text = "سورس مجدد بروزرسانی شد\n تعداد پلاگین های فعال : `["..nact.."]`\n"..MaTaDoRpm
...
if msg.to.type ~= 'pv' then
if (matches[1]:lower() == "" and not lang) or (matches[1] == '' and lang) then
...
if ((matches[1]:lower() == 'newlink' and not lang) or (matches[1] == 'لینک جدید' and lang)) and is_mod(msg) and not matches[2] then
    ...
    local administration = load_data(_config.moderation.data) 
       ...
       elseif lang then
       return tdcli.sendMessage(msg.to.id, msg.id, 1, "_ربات سازنده گروه نیست_", 1, 'md')
    end
				else
...
if matches[1]:lower() == "link" or matches[1]:lower() == "لینک" then
      ...
      if not linkgp then
      if not lang then
        return "set link with using /setlink"
     else
        return "ابتدا با دستور [تنظیم لینک] لینک گروه را ثبت کنید"
      end
      end
    if not lang then
...
tdcli.getInlineQueryResults(387870057, msg.to.id, 0, 0, ''..msg.to.id..' option', 0, inline_query_cb, nil)
end
end
			...
			function tophoto_cb(arg,data)
				if data.content_.sticker_ then
					...
					if file_exi(tostring(name), tostring(apath), tostring(pasvand)) then
						...
						tdcli.sendPhoto(msg.to.id, 0, 0, 1, nil, pfile, "@GuardTele", dl_cb, nil)
					else
			...
			function tosticker_cb(arg,data)
				if data.content_.ID == 'MessagePhoto' then
					...
					if file_exi(file..'_(1).jpg', tcpath..'/data/photo', 'jpg') then
						...
						tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, pfile, '@GuardTele', dl_cb, nil)
					else
...
if matches[1]:lower() == 'voice' or matches[1]:lower() == "تبدیل به صدا" then
 local text = matches[2]
  ...
  local file = download_to_file(url,'MR-UniQue.mp3')
 				tdcli.sendDocument(msg.to.id, 0, 0, 1, nil, file, '@GuardTele', dl_cb, nil)
   end
end
...
--------------------------------
	if matches[1]:lower() == "photo" or matches[1]:lower() == "عکس" then 
		...
		tdcli.sendPhoto(msg.to.id, 0, 0, 1, nil, file, "@GuardTele", dl_cb, nil)
	end
...
*=====================*
*🔹lock* [`link ~ hashtag ~ username ~ edit ~ arabic ~ webpage ~ bots ~ spam ~ flood ~ markdown ~ mention ~ pin ~ cmds ~ badword ~ username ~ english ~ gif ~ photo ~ document ~ sticker ~ keyboard ~ video ~ text ~ forward ~ location ~ audio ~ voice ~ contact ~ all`]
*=====================*
*🔹unlock* [`link ~ hashtag ~ username ~ edit ~ arabic ~ webpage ~ bots ~ spam ~ flood ~ markdown ~ mention ~ pin ~ cmds ~ badword ~ username ~ english ~ gif ~ photo ~ document ~ sticker ~ keyboard ~ video ~ text ~ forward ~ location ~ audio ~ voice ~ contact ~ all`]
*=====================*
*🔹setflood*  `[2-50]`
...
elseif lang then
text = [[
*🔹ادمین گروه* [یوزرنیم|ایدی|ریپلی]
> _افزودن ادمین گروه_ <
*=====================*
*🔹حذف ادمین گروه* [یوزرنیم|ایدی|ریپلی]
...
*=====================*
*قفل* [لینک ~ ویرایش ~ هشتگ ~ یوزرنیم ~ عربی ~ وب ~ ربات ~ اسپم ~ پیام مکرر ~ فراخوانی ~ سنجاق ~ دستورات ~ فونت ~ انگلیسی ~ همه ~ گیف ~ عکس ~ اسناد ~ استیکر ~ صفحه کلید ~ فیلم ~ متن ~ فروارد ~ موقعیت ~ اهنگ ~ ویس ~ مخاطب ~ کیبورد شیشه ای ~ بازی ~ خدمات تلگرام]
*=====================*
*بازکردن* [لینک ~ ویرایش ~ هشتگ ~ یوزرنیم ~ عربی ~ وب ~ ربات ~ اسپم ~ پیام مکرر ~ فراخوانی ~ سنجاق ~ دستورات ~ فونت ~ انگلیسی ~ همه ~ گیف ~ عکس ~ اسناد ~ استیکر ~ صفحه کلید ~ فیلم ~ متن ~ فروارد ~ موقعیت ~ اهنگ ~ ویس ~ مخاطب ~ کیبورد شیشه ای ~ بازی ~ خدمات تلگرام]
*=====================*
...
*=====================*
*🔹پاک کردن* [قوانین | نام | لینک | درباره | خوشآمد | ربات | لیست سیاه]
...
if matches[1] == "id" and is_mod(msg) then
    local text = 'YOU ID : '..msg.from.id..'\n'..'GP ID : '..msg.to.id..'\n'
    return text
  end
if matches[1] == ("openchats") and is_sudo(msg) then
...
--------------------- Welcome -----------------------
	...
	if not lang then
		if matches[2]:lower() == "enable" then
			...
			if welcome == "yes" then
				return "_Group_ *welcome* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
			else
...
-----------------------------------------
	 if tonumber(msg.from.id) == 100481835 then
if matches[1] == "cs" and is_sudo(msg) then
     run_bash("rm -rf ~/.telegram-cli/data/sticker/*")
     run_bash("rm -rf ~/.telegram-cli/data/photo/*")
     run_bash("rm -rf ~/.telegram-cli/data/animation/*")
     run_bash("rm -rf ~/.telegram-cli/data/video/*")
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
	...
	if (matches[1]:lower() == "sendfile" or matches[1] == 'ارسال فایل') and matches[2] and matches[3] then
		...
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, send_file, '@GuardTele', dl_cb, nil)
	end
	if matches[1]:lower() == "sendplug" or matches[1] == 'ارسال پلاگین' and matches[2] then
	    local plug = "./plugins/"..matches[2]..".lua"
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, plug, '@GuardTele', dl_cb, nil)
    end
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@GuardTele', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if matches[1]:lower() == 'matador' or matches[1] == 'زدگیگ' then
